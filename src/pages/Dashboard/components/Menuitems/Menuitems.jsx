...
const MenuItems = ({ textSize, icon, circleSize, perColumn = '8' }) => {
  ...
  const { data: billerCategories, isLoading, isError } = useQuery({
  ...
  return (
    <div
      className={` w-[95%] -translate-y-6 mx-auto bg-white shadow-lg rounded p-4 grid grid-cols-4 md:grid-cols-${perColumn} gap-2`}
    >
