...
const AcountCan = ({
  ...
  return (
    <div className="bg-theme-primary text-white p-4 rounded-lg shadow-md shadow-gray-500 my-8 min-w-full md:min-w-[60%] mx-4 md:mx-0">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-sm md:text-2xl font-bold capitalize">
          Account No.
        </h1>
        <div className="flex items-center gap-4 text-sm md:text-2xl">
          <h1 className="account-number">{accountNumber}</h1>
          <button className="py-1 rounded-lg copy-btn" onClick={handleCopy}>
